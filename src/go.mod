module github.com/sb-icon/icon-go-api
...
replace github.com/zaffka/mongodb-boltdb-mock => github.com/zaffka/mongodb-boltdb-mock v0.0.0-20221014194232-b4bb03fbe3a0
